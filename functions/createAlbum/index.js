...
exports.main = async (event, context) => {
  ...
  try {
    ...
    const newAlbum = {
      ...
      src_images: albumData.src_images,
      ...
      enable_custom_prompt: albumData.enable_custom_prompt,
      custom_prompt: albumData.custom_prompt,
      custom_prompt_tips: albumData.custom_prompt_tips,
      ...
      exclude_result_image: albumData.exclude_result_image !== undefined ? albumData.exclude_result_image : true,
      is_multi_person: albumData.is_multi_person !== undefined ? albumData.is_multi_person : false,
